	...
	public void renderIcon() {
		...
		if (stack != null && stack.getItem() != null) {
			if (stack.getItem() instanceof ItemBlock) {
				GlassesRenderingUtils.renderRotatingBlockIntoGUI(renderer, clientStack, this.x + 1, this.y + 1, (float)this.scale, (float)this.angle);
			} else {
				GlassesRenderingUtils.renderItemIntoGUI(renderer, clientStack, this.x, this.y, (float)this.scale);
			}
		}
	}

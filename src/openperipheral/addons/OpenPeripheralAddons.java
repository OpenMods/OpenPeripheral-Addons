...
@Mod(modid = "OpenPeripheral", name = "OpenPeripheralAddons", version = "@VERSION@", dependencies = "required-after:OpenMods@[0.4,];required-after:ComputerCraft@[1.6,];after:OpenPeripheralCore")

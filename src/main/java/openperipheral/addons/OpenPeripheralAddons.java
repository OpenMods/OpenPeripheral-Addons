...
@Mod(modid = "OpenPeripheral", name = "OpenPeripheralAddons", version = "@VERSION@", dependencies = "required-after:OpenMods@[0.5,];required-after:ComputerCraft@[1.60,];required-after:OpenPeripheralCore")
